...
var GroundControl = function (_React$Component) {
  _inherits(GroundControl, _React$Component);

  function GroundControl(props, context) {
    _classCallCheck(this, GroundControl);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GroundControl).call(this, props, context));
